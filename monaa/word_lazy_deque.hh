...
class WordContainer : public AbstractTimedWordContainer
{
protected:
...
public:
  /*!
    ...
    @param [in] file The name of the file that the input timed word is in. If the container does not use the timed word in a file (e.g., when a result of simulation is directly passed), this can be ignored.
